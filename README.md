...
本项目是一个基于xv6-RISCV实现的小型内核操作系统，旨在开发过程中对xv6的各个模块进行改进和优化。在原有基础上，我们分别在进程调度、内存管理、文件管理几个方面完善了功能。截至目前一共52个系统调用，为用户提供了更丰富的系统服务。
...
<img src="./docs/img/BirdOS架构.png" alt="BirdOS架构" style="zoom: 50%;" />
